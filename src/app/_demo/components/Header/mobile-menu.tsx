...
const MobileMenu: React.FC = () => {
    ...
    return (
        <>
            ...
            <div
                className={`fixed inset-0 bg-black bg-opacity-50 z-[99999] md:hidden transition-opacity duration-300 ease-in-out ${isOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
                    }`}
                onClick={toggleMenu}
            >
                <div
